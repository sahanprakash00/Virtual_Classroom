        ...
        <div class="creatClass_box">  	
            ...
            <div id="first">
             ...
             <div class="assignment_section">
                    ...
                    <form action="createJoinClass.php" method="POST">
                        <input type="text" name="assignmentName" autocomplete="off" placeholder="Assignment Name">
                        <textarea name="assignmentDescription" placeholder="Assignment Description"></textarea>
                        <button type="submit" name="addAssignment_button">Add Assignment</button>
                    </form>
                </div>
            ...
            <div id="second">
                ...
                <form action="createJoinClass.php" method="POST">
                    ...
                    <br>
                    <button class="cancel_button"><a href="index.php">Cancel</a></button>
                    <button type="submit" name="joinClass_button" id="create_class_button">Join</button>
                    <br>
                    <br>
